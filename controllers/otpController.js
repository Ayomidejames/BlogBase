            ...
            const mailObj = {
                ...
                <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; max-width: 600px; margin: 0 auto; border: 1px solid #eee; padding: 20px; border-radius: 8px;">
                    ...
                    <div style="text-align: center; margin: 25px 0;">
                        <a href="${process.env.BLOGBASE_LOGIN_URL || 'https://vendify.com/login'}" style="background-color: #007bff; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold;">Proceed to Login</a>
                    </div>
